        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 xl:gap-12">
          ...
          <div className="md:col-span-5 space-y-6">
            ...
            <p className="max-w-md text-sm text-muted-foreground leading-relaxed">
              NeedSpeak leverages advanced AI semantic translation to turn natural human context—recipes, group details, budgets, and text instructions—into instant, optimized, checkout-ready shopping carts.
            </p>
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link to="/chat" className="text-muted-foreground transition-colors duration-200 hover:text-foreground">
                  AI Chat
                </Link>
              </li>
              <li>
                <Link to="/occasions" className="text-muted-foreground transition-colors duration-200 hover:text-foreground">
                  Occasions
                </Link>
              </li>
              <li>
                <Link to="/recipe" className="text-muted-foreground transition-colors duration-200 hover:text-foreground">
                  Recipe Importer
                </Link>
              </li>
              <li>
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link to="/preferences" className="text-muted-foreground transition-colors duration-200 hover:text-foreground">
                  User Settings
                </Link>
              </li>
              <li>
                <Link to="/login" className="text-muted-foreground transition-colors duration-200 hover:text-foreground">
                  Account
                </Link>
              </li>
              <li>
                <a href="#docs" className="text-muted-foreground transition-colors duration-200 hover:text-foreground">
                  Developer API
                </a>
              </li>
              <li>
                <a href="#status" className="flex items-center gap-1.5 text-muted-foreground transition-colors duration-200 hover:text-foreground group">
                  System Status
