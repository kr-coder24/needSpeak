...
function LoginPage() {
  ...
  const handleMockGoogleLogin = async () => {
    ...
    setError("");
    try {
      // Mock Google Payload for Hackathon demo purposes
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="flex justify-center">
            <button
              ...
              className="flex h-11 w-full items-center justify-center gap-2 rounded-xl border border-border bg-card text-sm font-medium transition-colors hover:bg-muted/50"
            >
